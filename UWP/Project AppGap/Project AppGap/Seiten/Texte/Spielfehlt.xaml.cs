...
namespace Project_AppGap.Seiten.Texte
{
    ...
    /// </summary>
    public sealed partial class Spielfehlt : Page
    {
        public Spielfehlt()
        {
            ...
            string n_s1 = loader.GetString("spielfehlt_vorlage_1");
            n_s1 = n_s1.Replace("@%", "");
            V.Text = n_s1;
        ...
        private async void MailButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Piv.SelectedIndex == 0)
            {
                string n_s = loader.GetString("spielfehlt_vorlage_1");
                n_s = n_s.Replace("@%", "%0d%0A%0d%0A");
                var success = await Launcher.LaunchUriAsync(new Uri("mailto:?Subject=" + "Ihre Spiel fehlt" + "&Body=" + n_s, UriKind.Absolute));
            }
        }
        //END
    }
